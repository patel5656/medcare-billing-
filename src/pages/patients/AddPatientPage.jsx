...
export const AddPatientPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast('Failed to register patient. Please check your data and retry.', 'error');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Add New Patient Intake</h1>
        <p className="text-xs text-slate-500">
          Complete 4-Step Registration: Demographics, Contact, Insurance, 4-Provider Assignment &amp; Clinical History
        </p>
      </div>
          ...
          <div className="space-y-4 animate-in fade-in-50 duration-150 text-xs">
                ...
                <div className="flex flex-wrap gap-1.5 mb-2.5">
                  {QUICK_ALLERGIES.map(chip => (
                    <button
                      ...
                      className="text-[10px] px-2.5 py-1 rounded-lg bg-white hover:bg-teal-50 hover:text-teal-700 text-slate-700 border border-slate-200 transition cursor-pointer"
                    >
                      + {chip}
                    </button>
                  ))}
            ...
            <div className="bg-slate-50/70 p-4 rounded-2xl border border-slate-200 space-y-3">
              ...
              <div className="flex items-center gap-2 pt-1 border-t border-slate-200">
                ...
                />
                <label htmlFor="hipaaConsentPage" className="text-[11px] font-medium text-slate-700 cursor-pointer">
            ...
            <div className="bg-gradient-to-r from-teal-50/80 to-slate-50 p-4 rounded-2xl border border-teal-200 shadow-xs space-y-2.5">
          ...
          <div className="flex items-center gap-3">
            ...
            {currentStep < 4 ? (
              <button
                type="button"
                onClick={handleNext}
                className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold rounded-xl shadow-sm transition flex items-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-md transition flex items-center gap-2 cursor-pointer"
              >
