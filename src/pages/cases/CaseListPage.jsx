    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button 
          ...
          className="px-4 py-2.5 bg-teal-600 hover:bg-teal-700 active:scale-95 text-white text-xs font-bold rounded-xl shadow-sm transition flex items-center justify-center gap-1.5 self-start sm:self-auto cursor-pointer"
        >
                ...
                <div key={c.id} className="p-4 space-y-3 hover:bg-slate-50/70 transition">
                  ...
                  <div className="space-y-1 text-xs text-slate-600 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
                    ...
                    <p className="flex items-center gap-1.5">
                      ...
                      <span>Attorney: <strong className="text-slate-800">{c.attorneyName}</strong> ({c.lawFirm || 'Lien'})</span>
                    </p>
                  </div>
                  ...
                  {cases.map((c) => (
                    <tr key={c.id} className="hover:bg-slate-50/80 transition">
                      ...
                      <td className="p-3.5 text-slate-600">
                        ...
                        <p className="text-[10px] text-slate-400">{c.lawFirm}</p>
                      </td>
                      <td className="p-3.5">
                        <div className="flex flex-wrap gap-1">
                          {c.assignedProviderIds?.map(pid => (
