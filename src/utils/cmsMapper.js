...
export const mapBillToCms1500Claims = (bill, patientCase, providerConfig) => {
  ...
  return dosKeys.map((dosKey, idx) => {
    ...
    return {
      ...
      formVersion: '02/12',
      box1: 'OTHER',
      box1a: bill.insurancePolicyNumber || patientCase?.insurancePolicyNumber || ptObj?.primaryPolicyNumber || patientCase?.patient?.primaryPolicyNumber || '',
      box2: patientName,
      box3Dob,
      box3Sex: patientSex,
      box4: patientName,
      ...
      box11InsuredSex,
      box11b: '',
      box11c: bill.insuranceCompany || patientCase?.insuranceCompany || ptObj?.primaryInsuranceCompany || patientCase?.patient?.primaryInsuranceCompany || '',
      box11d,
