...
export const PACKET_MANIFESTS = {
  ...
  'prov-davs': {
    ...
    pages: [
      ...
      { pageNumber: 4, id: 'davs-cms-1', type: 'CMS-1500', title: 'CMS-1500 Claim Form', componentKey: 'CmsRedGridForm', claimIndex: 0 },
      { pageNumber: 5, id: 'davs-cms-2', type: 'CMS-1500', title: 'CMS-1500 Claim Form', componentKey: 'CmsRedGridForm', claimIndex: 1 },
      { pageNumber: 6, id: 'davs-cms-3', type: 'CMS-1500', title: 'CMS-1500 Claim Form', componentKey: 'CmsRedGridForm', claimIndex: 2 },
      { pageNumber: 7, id: 'davs-prog-1', type: 'ASSESSMENT', title: 'Clinical Progress Note (Page 1)', componentKey: 'DavProgressNote', notePage: 1 },
      { pageNumber: 8, id: 'davs-prog-2', type: 'ASSESSMENT', title: 'Clinical Progress Note (Page 2)', componentKey: 'DavProgressNote', notePage: 2 },
      { pageNumber: 9, id: 'davs-proc-1', type: 'PROCEDURE', title: 'ESWT Shockwave Form (01/22/2026)', componentKey: 'DavEswtProcedureForm', pageIndex: 0, formPage: 1, dos: '01/22/2026' },
      { pageNumber: 10, id: 'davs-proc-2', type: 'PROCEDURE', title: 'ESWT Shockwave Form (01/24/2026)', componentKey: 'DavEswtProcedureForm', pageIndex: 1, formPage: 2, dos: '01/24/2026' },
      { pageNumber: 11, id: 'davs-proc-3', type: 'PROCEDURE', title: 'ESWT Shockwave Form (01/26/2026)', componentKey: 'DavEswtProcedureForm', pageIndex: 2, formPage: 3, dos: '01/26/2026' },
