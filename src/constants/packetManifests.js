...
export const PACKET_MANIFESTS = {
  ...
  'prov-davs': {
    ...
    pages: [
      ...
      { pageNumber: 9, id: 'davs-proc-1', type: 'PROCEDURE', title: 'ESWT Shockwave Form', componentKey: 'DavEswtProcedureForm', pageIndex: 0, formPage: 1 },
      { pageNumber: 10, id: 'davs-proc-2', type: 'PROCEDURE', title: 'ESWT Shockwave Form', componentKey: 'DavEswtProcedureForm', pageIndex: 1, formPage: 2 },
      { pageNumber: 11, id: 'davs-proc-3', type: 'PROCEDURE', title: 'ESWT Shockwave Form', componentKey: 'DavEswtProcedureForm', pageIndex: 2, formPage: 3 },
